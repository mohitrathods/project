...
<div class="head">
   <h2>Salesman data</h2>
   <a href="sadd.php">add salesman</a>
</div>
<!-- HOME -->
<div class="home">
<table border="1px">
   ...
   ?>
   <tr>
       <td><?php echo $eachitem['salesman_id'] ?></td>
       ...
       <td><a href="sedit.php?id=<?php echo $eachitem['salesman_id'] ?>">EDIT</a></td>
       <td><a href="sdelete.php?id=<?php echo $eachitem['salesman_id'] ?>">DELETE</a></td>
   </tr>
   <?php
   }
